...
**Vision Attractor** — аналитический дашборд, отвечающий на вопрос: «Как люди с такими ценностями ведут себя в жизненных ситуациях?». Пользователь задаёт демографический профиль и выбирает ценности — система показывает релевантные ситуации со стратегиями и вероятностями. Граф ценностей доступен как инструмент исследования.
...
┌─────────────────────────────────────────────────────────┐
│  ВВОД (Profile)                                         │
│  Демография + визуальный пикер топ-3 ценностей          │
├─────────────────────────────────────────────────────────┤
...
│  B) D3-граф ценностей (opt-in exploration)              │
└─────────────────────────────────────────────────────────┘
```
...
│   │   └── AttractorPicker.vue      ← НОВЫЙ: визуальный пикер ценностей
...
- `CollapsibleSection` «Ваши ценности» → `AttractorPicker`
- Все мутации через `dispatch()`

`src/components/AttractorPicker.vue` — визуальный пикер ценностей:
...
- `CollapsibleSection` «Демография» и «Ценности» — как в текущем RightPanel
...
| ID | Где | Текст |
|----|-----|-------|
| `cm-profile` | ProfileSidebar | «Выберите ваши ценности — карточки подстроятся» |
...
├── AttractorPicker.vue   # Визуальный пикер ценностей
